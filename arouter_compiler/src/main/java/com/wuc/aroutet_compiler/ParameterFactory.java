...
public class ParameterFactory {
  ...
  // 类名，如：MainActivity  /  PersonalMainActivity
  ...
  private ParameterFactory(Builder builder) {
    ...
    // 生成此方法
    // 通过方法参数体构建方法体：@Override public void getParameter(Object target) {
  ...
  public void buildStatement(Element element) {
    ...
    if (type == TypeKind.INT.ordinal()) {
      ...
      } else if (typeUtils.isSubtype(typeMirror, callMirror)) {// 实现了Call接口
