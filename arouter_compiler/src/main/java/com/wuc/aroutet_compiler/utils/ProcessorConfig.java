...
public interface ProcessorConfig {
  // @ARouter注解 的 包名 + 类名
  String AROUTER_PACKAGE = "com.wuc.arouter_annotation.ARouter";
  // 接收参数的TAG标记
  ...
  // ARouter api 包名
  String AROUTER_API_PACKAGE = "com.wuc.arouter_api";
  ...
  // @Parameter注解 的 包名 + 类名
  String PARAMETER_PACKAGE = "com.wuc.arouter_annotation.Parameter";
